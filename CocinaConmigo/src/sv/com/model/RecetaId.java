...
/**
 * RecetaId generated by hbm2java
 */
public class RecetaId implements java.io.Serializable {
	...
	public RecetaId(int idReceta, int idCategoria, int idUsuario, int idTipoComida) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RecetaId))
			return false;
		RecetaId castOther = (RecetaId) other;

		return (this.getIdReceta() == castOther.getIdReceta()) && (this.getIdCategoria() == castOther.getIdCategoria())
